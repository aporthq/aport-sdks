...
app.post(
  "/api/refunds",
  requirePolicy("payments.refund.v1", AGENT_ID), // ← Agent ID passed explicitly
  (req, res) => {
...
app.post(
  ...
  (req, res, next) => {
    ...
    return requirePolicyWithContext("data.export.v1", AGENT_ID, context)(
      req,
      res,
      next
    );
...
app.post(
  ...
  (req, res, next) => {
    ...
    return requirePolicyWithContext("repo.v1", AGENT_ID, context)(
      req,
      res,
      next
    );
...
app.post(
  ...
  (req, res, next) => {
    ...
    return requirePolicyWithContext("messaging.v1", AGENT_ID, context)(
      req,
      res,
      next
    );
 ...
 *        return requirePolicyWithContext("data.export.v1", AGENT_ID, context)(req, res, next);
 *      },
 *      handler
 *    )
 *
