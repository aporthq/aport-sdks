...
app.post(
  ...
  (req, res, next) => {
    ...
    req.policyId = "payments.refund.v1";
    next();
  },
  refundsMiddleware1,
  (req, res) => {
...
app.post(
  "/api/data/export",
  requirePolicy("data.export.v1", AGENT_ID), // ← Agent ID passed explicitly
  (req, res) => {
    // Your business logic - policy already verified!
    res.json({
      success: true,
