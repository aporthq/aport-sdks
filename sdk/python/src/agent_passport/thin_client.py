...
class PolicyVerifier:
    ...
    async def verify_refund(
        ...
        """Verify the payments.refund.v1 policy."""
        return await self.client.verify_policy(
            agent_id, "payments.refund.v1", context, idempotency_key
        )
    ...
    async def verify_release(
        ...
        """Verify the release.v1 policy."""
        return await self.client.verify_policy(
            agent_id, "release.v1", context, idempotency_key
        )
    ...
    async def verify_data_export(
        ...
        """Verify the data.export.v1 policy."""
        return await self.client.verify_policy(
            agent_id, "data.export.v1", context, idempotency_key
        )
    ...
    async def verify_messaging(
        ...
        """Verify the messaging.v1 policy."""
        return await self.client.verify_policy(
            agent_id, "messaging.v1", context, idempotency_key
        )
    ...
    async def verify_repository(
        ...
        """Verify the repo.v1 policy."""
        return await self.client.verify_policy(
            agent_id, "repo.v1", context, idempotency_key
        )