...
class TestAPortClient:
    ...
    async def test_verify_policy_success(self):
        ...
        with patch("aiohttp.ClientSession", return_value=mock_session):
            ...
            assert call_args[1]["url"] == "https://api.aport.io/api/verify/policy/payments.refund.v1"
    ...
    async def test_verify_policy_with_reasons(self):
        ...
        with patch("aiohttp.ClientSession", return_value=mock_session):
            ...
            client._session = mock_session
            result = await client.verify_policy(
                "test-agent", "payments.refund.v1", {"amount": 1000, "currency": "USD"}
            )
    ...
    async def test_verify_policy_api_error(self):
        ...
        with patch("aiohttp.ClientSession", return_value=mock_session):
            ...
            with pytest.raises(AportError) as exc_info:
                await client.verify_policy("test-agent", "payments.refund.v1", {})
    ...
    async def test_get_decision_token(self):
        ...
        with patch("aiohttp.ClientSession", return_value=mock_session):
            ...
            call_args = mock_session.request.call_args
            assert call_args[1]["method"] == "POST"
            assert call_args[1]["url"] == "https://api.aport.io/api/verify/token/payments.refund.v1"
